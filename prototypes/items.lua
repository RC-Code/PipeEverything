...
{
	{
		...
		order = "b[fluid]-a[iron-ore-fluid]",
		place_result = "flusher",
		stack_size = 50
	},
	{
		type = "item",
	...
	},
	{
		...
		subgroup = "production-machine",
		order = "b[fluid]-a[iron-ore-fluid]",
		place_result = "liquid-assembly-machine",
		stack_size = 50
	},
{
		type = "item",
		...
		subgroup = "production-machine",
		order = "b[fluid]-a[iron-ore-fluid]",
		place_result = "liquid-assembly-machine-2",
		stack_size = 50
	},
{
		type = "item",
		...
		subgroup = "production-machine",
		order = "b[fluid]-a[iron-ore-fluid]",
		place_result = "liquid-assembly-machine-3",
		stack_size = 50
	},	
})